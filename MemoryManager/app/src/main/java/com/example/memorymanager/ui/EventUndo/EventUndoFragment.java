...
public class EventUndoFragment extends Fragment implements EventPageControl {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //创建页面输出提示信息
        Toast.makeText(super.getContext(),"fragment_event_undo created",Toast.LENGTH_LONG).show();
        //界面的Layout事件容器控件
    ...
    private void initBackButton(){
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TemporaryAction.setIfFromPageEventInfo(false);
                TemporaryAction.setPriorPage(PagesName.page_itemType);
                startActivity(new Intent(EventUndoFragment.super.getContext(), Activity_SetEvent.class));
            }
        });
    }
